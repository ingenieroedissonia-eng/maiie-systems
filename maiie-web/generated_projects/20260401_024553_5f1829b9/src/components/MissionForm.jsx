"""
Modulo: MissionForm
Capa: Presentation (Component)

Descripcion:
Componente de React que renderiza un formulario para que los usuarios
puedan definir y enviar nuevas órdenes de misión.

Responsabilidades:
- Renderizar los campos de entrada para el nombre y la descripción de la misión.
- Manejar el estado interno de los campos del formulario.
- Realizar validaciones básicas para asegurar que los campos no estén vacíos.
- Invocar una función callback (`onSendOrder`) al enviar el formulario con los datos de la misión.
